...
class GenerateAllReports():
	...
	def generate_all_reports(self):
		self.report_files_list = glob.glob("RC_CI-master/auto_testing_CI/*_content.txt")
		...
		report_footer_1 = "<p>[1] ET QE PSI pipeline is used to track all
        processes of build/commit testings, including enviroment preparation, testing, results collection and reports by on click.</p>"
		...
		report_footer_5 = "<p>Anything about the reports or the testings, you
        can join #errata-qe or send mail to 'errata-qe-team' for help.</p>"
