...
class CollectAllReportsAndUpdateToConfluence():
	def __init__(self, username, password, confluence_username, confluence_password, et_rc_version, title, space, parent_page):
		...
		self.each_rc_report = ""
		self.file = file
		self.build_name_list = ['errata-qe-test/e2e-post-merge-pipeline', 'errata-qe-test/baseline-performance-pipeline', 'errata-qe-test/bug-regression-pipeline', 'errata-qe-test/ts2-post-merge-pipeline']
